        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
              ...
              <span className="block text-emerald-600">المتوافقة مع الشريعة</span>
            </h2>
            <p className="text-xl text-gray-600 mb-10 leading-relaxed">
              منصة ثورية تستخدم تقنية البلوك تشين لضمان شفافية المعاملات المالية الإسلامية 
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3 space-x-reverse">
                  ...
                  <p className="text-gray-700">العقود المالية في Web2 غامضة وغير واضحة</p>
                </div>
                <div className="flex items-start space-x-3 space-x-reverse">
                  <div className="w-2 h-2 bg-red-500 rounded-full mt-3"></div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3 space-x-reverse">
                  <CheckCircle className="w-6 h-6 text-emerald-500 mt-1 flex-shrink-0" />
                  <p className="text-gray-700">شفافية كاملة باستخدام تقنية البلوك تشين</p>
                </div>
                <div className="flex items-start space-x-3 space-x-reverse">
                  <CheckCircle className="w-6 h-6 text-emerald-500 mt-1 flex-shrink-0" />
      ...
      <section id="features" className="py-20 bg-gradient-to-r from-emerald-50 to-teal-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">حلول شاملة للتمويل الإسلامي في عصر البلوك تشين</p>
          </div>
      ...
      <section id="how-it-works" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">عملية بسيطة وآمنة في ثلاث خطوات</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <h4 className="text-xl font-bold text-gray-900 mb-4">التوثيق على البلوك تشين</h4>
              <p className="text-gray-600">
                يُحفظ العقد كـ NFT على البلوك تشين لضمان الشفافية والأمان
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 text-center text-white">
            ...
            <div>
              ...
              <div className="text-emerald-100">مراجعة تلقائية</div>
            </div>
            <div>
      ...
      <section className="py-20 bg-gradient-to-r from-emerald-600 to-teal-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="border-2 border-white text-white hover:bg-white hover:text-emerald-600 px-8 py-4 rounded-xl text-lg font-semibold transition-all">
              تعلم المزيد
            </button>
          </div>
        </div>
